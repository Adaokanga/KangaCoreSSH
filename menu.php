...
require "/opt/KangaCore/proxykanga.php";
...
require "/opt/KangaCore/limiterstart.php";
require "/opt/KangaCore/bottg.php";
require "/opt/KangaCore/banner.php";   // módulo do banner
...
// --- FUNÇÕES DE SAÍDA DE TEXTO PARA O BASH ---
function menu() {
...
// Função auxiliar para chamar o banner a partir do menu (opção 15)
function banner() {
    banner_menu();
}
